...
#define STRING_CONFIG_H_AUTHOR "(FromtonRouge, TEVO TORNADO)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.87, 79.45, 399.29, 400 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 1000, 120, 10000 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.09   // Z offset: -below +above  [the nozzle]
